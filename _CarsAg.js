...
//? @return {Object} - agency object
 carMarket.getAgencyByName = function (name) {
  return this.sellers.find(obj => obj.agencyName == name);
}
...
carMarket.getAgencyIdByName = function (name) {
  let agency = this.getAgencyByName(name);
  if(agency !== undefined ) {
...
carMarket.getAllAgenciesName = function () {
   agenciesNameArr = this.sellers.map(function(el) {
     return el.agencyName;
     
  });
}
console.log(carMarket.getAllAgenciesName(agenciesNameArr));
